...
public class ObservationDiffer
    ...
    private static Javers makeObservationJavers() {
        ...
        return JaversBuilder.javers()
                ...
                .registerCustomComparator(new SinglePropertyToStringComparator<>("customId"), SamplingLocation.class)
                .registerCustomComparator(new SinglePropertyToStringComparator<>("customId"), ObservedProperty.class)
                .registerCustomComparator(new SinglePropertyToStringComparator<>("customId"), LabAnalysisMethod.class)
                .registerCustomComparator(new SinglePropertyToStringComparator<>("customId"), Activity.class)
                .registerCustomComparator(new SinglePropertyToStringComparator<>("customId"), FieldVisit.class)
                .registerCustomComparator(new SinglePropertyToStringComparator<>("customId"), Laboratory.class)
                .registerCustomComparator(new SinglePropertyToStringComparator<>("customId"), LabReport.class)
                .registerCustomComparator(new SinglePropertyToStringComparator<>("name"), Specimen.class)
